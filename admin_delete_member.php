...
$result ="";
$result = mysql_query("select member_id from member ORDER BY membership_type");
if(isset($_POST['submit'])) ///forsubmit data
{
$mid=$_POST['org'];
$delres=mysql_query("delete from member where member_id=\"$mid\"");
