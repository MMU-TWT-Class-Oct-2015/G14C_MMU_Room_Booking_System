...
<body>
  ...
  <p align="right"><font size="6" face="Georgia" color="#000000">
  <a href="staff_records.php">Booking Records</a></font></p>
        <?php
        ...
        <form name="get_roomid" action="staff_page.php" method="post" >
          ...
          <td>
            ...
            <tr>
            <td>
            <button type="submit" name="submit" action="staff_page.php">NEXT</button>
          </td>
          </tr>
          </table>
        </form>
        ...
        <script>function loadrid(){
            ...
            xmlhttp.open('GET', 'staff_load_roomid.php?room_type='+rtype, true);
