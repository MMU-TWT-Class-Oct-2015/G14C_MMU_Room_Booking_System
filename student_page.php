...
VALUES('$uname','$org_name','$t_start','$t_end','".$_POST['roomid']."','$sortdate', '$n_o_p')"))
  ...
  window.location.href='student_room_book.php';
  </script>";
		}
		else
		{
...
<body>
  <p align="right"><font size="6" face="Georgia" color="#000000">
	<a href="student_room_book.php">HOME</a></font></p>
	<p align="right"><font size="6" face="Georgia" color="#000000">
...
<tr>
<td><input type="text" name="nop" placeholder="Number Of Participants" required /></td>
</tr>
<tr>
